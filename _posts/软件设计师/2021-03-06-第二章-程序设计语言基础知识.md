...
2. 词法分析
   ...
   2. 有限自动机
      ...
      ![（a）状态转换图](https://github.com/BalboZheng/BalboZheng.github.io/blob/master/img/software/state_transition_1.png?raw=true)
      ...
      2. 不确定的有限自动机(Nondeterministic Finite Automata, NFA)。一个不确定的有限自动机是一个五元组，它与确定的有限自动机的区别如下。
         ...
         ![（a）状态转换图](https://github.com/BalboZheng/BalboZheng.github.io/blob/master/img/software/state_transition_2.png?raw=true)
     ...
     1. 有限自动机转换为正规式
        ...
        对于 $\sum$ 上的 $NFAM$，可以构造一个 $\sum$ 上的正规式 R，使得 $L(R)=L(M)$。
          ...
          2. 按下面的方法逐步消去 $M^‘$ 中除 x 和 y 的所有结点。在消除结点的过程中，用正规式来标记弧，最后结点 x 和 y 之间弧上的标记就是所求的正规式。消除结点的规则如图所示。
             ...
             ![（a）状态转换图](https://github.com/BalboZheng/BalboZheng.github.io/blob/master/img/software/state_transition_3.png?raw=true)
     ...
     2. 正规式转换为有限自动机
         ...
         对于 $\sum$ 上的每个正规式 $R$，可以构造一个 $\sum$ 上的 $NFAM$，使得 $L(M)=L(R)$。
          ...
          1. 对于正规式 R，可用拓广图表示。
             ...
             ![（a）状态转换图](https://github.com/BalboZheng/BalboZheng.github.io/blob/master/img/software/outreach.png?raw=true)

          2. 按下面的方法逐步消去 $M^‘$ 中除 x 和 y 的所有结点。在消除结点的过程中，用正规式来标记弧，最后结点 x 和 y 之间弧上的标记就是所求的正规式。消除结点的规则如图所示。

             ![（a）状态转换图](https://github.com/BalboZheng/BalboZheng.github.io/blob/master/img/software/state_transition_4.png?raw=true)
...
6. 语法制导翻译和中间代码生成
     ...
     1. 中间代码
        ...
        2. 树形表示。例：x:=(a+b)\*(c+d)，表示为：
           ...
           ![（a）状态转换图](https://github.com/BalboZheng/BalboZheng.github.io/blob/master/img/software/tree.png?raw=true)
